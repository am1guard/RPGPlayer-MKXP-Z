...
static void mriBindingInit() {
    ...
    rb_eval_string_protect(
        ...
        "    return false if name_lower == 'socket' || name_lower == 'socket.so'\n"
        "    return false if name_lower.end_with?('/socket.rb') || name_lower.end_with?('/socket.so')\n"
        "    return false if name_lower == 'io/wait' || name_lower == 'io/wait.so'\n"
        "    return false if name_lower == 'io/nonblock' || name_lower == 'io/nonblock.so'\n"
        "    return false if name_lower == 'io/console' || name_lower == 'io/console.so'\n"
        "    return false if name_lower.end_with?('/io/wait') || name_lower.end_with?('/io/wait.rb') || name_lower.end_with?('/io/wait.so')\n"
        "    return false if name_lower.end_with?('/io/nonblock') || name_lower.end_with?('/io/nonblock.rb') || name_lower.end_with?('/io/nonblock.so')\n"
        "    return false if name_lower.end_with?('/io/console') || name_lower.end_with?('/io/console.rb') || name_lower.end_with?('/io/console.so')\n"
